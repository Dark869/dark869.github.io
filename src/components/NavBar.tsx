         ...
         <nav className={navStyles.nav}>
            <ul className={navStyles.ul}>
               ...
               <Link href={routes.About}>
                  <li className={navStyles.li}>About me</li>
               </Link>
               <Link href={routes.Projects}>
                  <li className={navStyles.li}>Projects</li>
               </Link>
               <Link href={routes.Skills}>
                  <li className={navStyles.li}>Skills</li>
               </Link>
               <Link href={routes.Certifications}>
                  <li className={navStyles.li}>Certifications</li>
               </Link>
            </ul>
         </nav>
      </>
